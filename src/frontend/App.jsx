...
function App() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('acuaber:actualizar_pendientes', handleActualizar);
    window.addEventListener('focus', handleActualizar);
    return () => {
      window.removeEventListener('acuaber:actualizar_pendientes', handleActualizar);
      window.removeEventListener('focus', handleActualizar);
    };
  }, [licenciaActiva, seccion]);
  ...
  const renderContenido = () => {
    switch (seccion) {
      case "dashboard":
        return <Dashboard pagosPendientes={pagosPendientes} onActualizarPendientes={cargarPendientes} />;
